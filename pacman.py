...
import random
import math
#isso é as bibliotecas sendo importadas
...
#função de forma mais facil para pular linhas e verificar distancia 
def atualizartela() :
    for linhas in range(0,30):
...
#        muitaslinhas()
    ...
    #############################################################
# blocos de ação que repetem o movimento com as possibilidades randomizadas
